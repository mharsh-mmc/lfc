  ...
  <DropdownMenu>
    <DropdownMenuTrigger as-child>
      <Button variant="ghost" size="icon" class="relative">
        ...
        <Badge v-if="unreadCount > 0" class="absolute -top-1 -right-1 h-5 w-5 rounded-full p-0 text-xs">
    ...
    <DropdownMenuContent class="w-80 max-h-96 overflow-y-auto">
      ...
      <div class="p-2 border-t">
        <Link 
          href="/notifications" 
          class="block w-full text-center text-sm text-blue-600 hover:text-blue-800 py-2"
        >
